...
ThemeData dark = ThemeData(
  fontFamily: 'Roboto',
  primaryColor: const Color.fromARGB(255, 0, 221, 255),
  ...
  textButtonTheme: TextButtonThemeData(style: TextButton.styleFrom(foregroundColor: const Color(0xFFffbd5c))), colorScheme: const ColorScheme.dark(primary: Color(0xFFffbd5c), secondary: Color(0xFFffbd5c)).copyWith(error: const Color.fromARGB(255, 57, 7, 255)),
